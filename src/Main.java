public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("На данный момент,численность населения страны Y составляет " + сountryPopY + " человек. ");
        ...
        for(int x = 1; x <= 10; x++ ) {
            ...
            System.out.println("Год " + x + " , численность населения составляет " + сountryPopY + " человек. ");
        }
